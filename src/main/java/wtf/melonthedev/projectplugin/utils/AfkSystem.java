...
public class AfkSystem {
    ...
    public static void disableAfkMode(Player player) {
        ...
        if (StatusCommand.statusList.containsKey(player.getName())) {
            player.setDisplayName(ChatColor.translateAlternateColorCodes('&', "[" + StatusCommand.statusList.get(player.getName()) + ChatColor.RESET + "] " + player.getName()));
            player.setPlayerListName(ChatColor.translateAlternateColorCodes('&', "[" + StatusCommand.statusList.get(player.getName()) + ChatColor.RESET + "] " + player.getName()));
        } else {
